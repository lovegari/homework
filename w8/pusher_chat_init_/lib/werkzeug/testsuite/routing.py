...
class RoutingTestCase(WerkzeugTestCase):
    ...
    def test_alias_redirects(self):
        m = r.Map([
            r.Rule('/', endpoint='index'),
            r.Rule('/chat.html', endpoint='index', alias=True),
            r.Rule('/users/', defaults={'page': 1}, endpoint='users'),
            r.Rule('/users/chat.html', defaults={'page': 1}, alias=True,
                   endpoint='users'),
            r.Rule('/users/page/<int:page>', endpoint='users'),
        ...
        ensure_redirect('/chat.html', '/')
        ensure_redirect('/users/chat.html', '/users/')
